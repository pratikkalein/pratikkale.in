...
const components: Components = {
  ...
  table: ({ ...props }) => <table className="border-collapse border border-black dark:border-white p-1" {...props} />,
  th: ({ ...props }) => <th className="border border-black dark:border-white p-2 " {...props} />,
  td: ({ ...props }) => <td className="border border-black dark:border-white p-2" {...props} />,
